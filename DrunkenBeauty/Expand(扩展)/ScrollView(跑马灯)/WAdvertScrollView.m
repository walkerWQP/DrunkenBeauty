...
@interface WAdvertScrollViewOneCell : UICollectionViewCell
@property (nonatomic, strong) UIImageView *signImageView;
@property (nonatomic, strong) UILabel *titleLabel;
@end

@implementation WAdvertScrollViewOneCell
...
@interface WAdvertScrollViewTwoCell : UICollectionViewCell
...
@implementation WAdvertScrollViewTwoCell
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        self.backgroundColor = [UIColor clearColor];
...
static NSString *const advertScrollViewOneCell = @"WAdvertScrollViewOneCell";
static NSString *const advertScrollViewTwoCell = @"WAdvertScrollViewTwoCell";
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[WAdvertScrollViewOneCell class] forCellWithReuseIdentifier:advertScrollViewOneCell];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    if (self.advertScrollViewStyle == WAdvertScrollViewStyleMore) {
        WAdvertScrollViewTwoCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:advertScrollViewTwoCell forIndexPath:indexPath];
        ...
        WAdvertScrollViewOneCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:advertScrollViewOneCell forIndexPath:indexPath];
...
- (void)setAdvertScrollViewStyle:(WAdvertScrollViewStyle)advertScrollViewStyle {
    ...
    if (advertScrollViewStyle == WAdvertScrollViewStyleMore) {
        ...
        [_collectionView registerClass:[WAdvertScrollViewTwoCell class] forCellWithReuseIdentifier:advertScrollViewTwoCell];
    }
}
