//
//  UserWithdrawalViewController.m
//  DrunkenBeauty
//
...
@interface UserWithdrawalViewController ()<UITextFieldDelegate>
...
@implementation UserWithdrawalViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"用户提现";
    NSLog(@"%@",self.phoneNumberStr);
    [self makeUserWithdrawalViewControllerUI];
}

- (void)makeUserWithdrawalViewControllerUI {
